...
export default function FAQsTwo() {
  ...
  return (
    <section id ="faqs2" className="py-12 md:py-24">
        ...
        <div className="mx-auto mt-12 max-w-xl">
          ...
          >
            {faqItems.map((item) => (
              ...
              >
                <AccordionTrigger className="group w-full py-0.5 text-left cursor-pointer text-base hover:no-underline transition-all duration-300">
                  <div className="flex items-center">
                    <ChevronRight className="h-4 w-4 transition-all duration-500 ease-in-out group-data-[state=open]:rotate-90" />
                    <div className="ml-2">{item.question}</div>
                  </div>
                </AccordionTrigger>
                <AccordionContent className="origin-left overflow-hidden transition-all duration-700 ease-in-out data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down">
                  <p
                    className="pl-6 pr-2 text-muted-foreground text-base animate-fade-in"
